...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="graphs" style="min-height: 900px;">
	     <div class="xs">
        	...
        	<div class="Compose-Message">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <label>标题 : </label>
                        <input value="${update_task_name}" name="update_task_name" type="text" class="form-control1 control3" required>
                            <input  type="submit" class="btn btn_5 btn-lg btn-primary" value="确认修改" >  &nbsp; &nbsp;&nbsp;&nbsp;
