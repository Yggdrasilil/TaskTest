                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                     ...
                     <ol type="A">
                        ...
                        <li><input value="${c.choice_content}" name = "choice_content${c.choice_id}" type="text" class="form-control1 control3" style="width:88%"><input name="choice_isTrue" value="${c.choice_id}" type="checkbox" class="checkbox" style="float:right;margin-top: 1.8%; margin-right:4%;"><br><br></li>
                        </c:forEach>
