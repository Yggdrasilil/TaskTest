...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper" >
            ...
            <c:if test="${!empty subject[0]}">
                    <%--遍历SUBJECT对象获得内容及其答案--%>
                    <c:forEach items="${subject}" var="c">
                        <br><h3>作业${c.task_id}</h3>
                        ...
                        <c:if test="${c.subject_type%3 == 2 }"></c:if>
                            ...
                            ">
                                ...
                                <h5 style="float:right; margin-top:-14px; margin-right:13px">
                                    <a href="/UpdateSubject?update_subject_id=${c.subject_id}&&update_task_id=${c.task_id}&&update_subject_type=${c.subject_type}" class="secondary-content" style="color: #6D6D6D"> 修改题目 </a>
                                </h5>
                                <h5 style="float:right; margin-top:-14px; margin-right:13px">
            ...
            <c:if test="${empty subject[0]}">
                ...
                <div class="col-md-8 inbox_right move4">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="alert alert-danger move6" style=" font-size:40px; text-align:center; height:220px">
                                    <div class="move5" style=" margin-top:66px;"><b>提示:</b>还没有该类型题目</div>
                                </div><br>
                    ...
                    <div align="center">
                        <c:if test="${subject[0].subject_type != 1}">
                            <button onclick=window.location="/ManageAllSubjectOfA_Type?check_subject_type=${check_subject_type-1}" type="button" class="btn btn_5 btn-lg btn-primary" style="margin-right:30px;"> 上个类型 </button>
                        </c:if>
                        <c:if test="${subject[0].subject_type !=3}">
                            <button onclick=window.location="/ManageAllSubjectOfA_Type?check_subject_type=${check_subject_type+1}" type="button" class="btn btn_5 btn-lg btn-primary" style="margin-right:30px;"> 下个类型 </button>
                        </c:if>
                    </div>
                </div>
            </c:if>
