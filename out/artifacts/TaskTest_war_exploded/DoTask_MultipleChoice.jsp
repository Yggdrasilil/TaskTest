                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ol type="A" style="color:black;">
							<c:forEach items="${do_subject.choice}" var="c">
                                <li >
                                <input name="my_choice" value="${c.choice_id}" type="checkbox" class="checkbox" style=" float:right; margin-right:3%">
                                <div style=" margin-top:-30px; width:90%" class="input-group" > 
									<input type="text" class="form-control1" value="${c.choice_content}" readonly>
								</div><br>
                                </li>
							</c:forEach>
                        </ol>
