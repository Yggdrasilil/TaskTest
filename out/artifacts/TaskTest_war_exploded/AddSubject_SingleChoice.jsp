                        ...
                        <div class="alert alert-warning" role="alert" style="margin-bottom:-1%">
                            ...
                            <ol type="A">
                                <div id="choice">
                                    ...
                                    <li><input name = "choice_content1" type="text" class="form-control1 control3" style="width:88%"><input input name="choice_isTrue" value="1" type="radio"  style="float:right;margin-top: 1.4%; margin-right:4%;"><br></li>

                                    <li><input name = "choice_content2" type="text" class="form-control1 control3" style="width:88%"><input input name="choice_isTrue" value="2" type="radio"  style="float:right;margin-top: 1.4%; margin-right:4%;"><br></li>

                                    <li><input name = "choice_content3" type="text" class="form-control1 control3" style="width:88%"><input input name="choice_isTrue" value="3" type="radio"  style="float:right;margin-top: 1.4%; margin-right:4%;"><br></li>

                                    <li><input name = "choice_content4" type="text" class="form-control1 control3" style="width:88%"><input input name="choice_isTrue" value="4" type="radio"  style="float:right;margin-top: 1.4%; margin-right:4%;"><br></li>
