...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper" >
                                   ...
                                   <div class="panel panel-default">
                                       ...
                                       <div class="panel-body">
                                           ...
                                           <div class="alert alert-danger move6" style=" font-size:40px; text-align:center; height:220px">
                                               <div class="move5" style=" margin-top:66px;"><b>提示:</b>没有作业了</div>
                                           </div><br>
            ...
            <c:if test="${empty task.subject && task.task_id != 0}">
                <br>
                <div class="col-md-8 inbox_right move4">
                    <div class="Compose-Message">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <br><br><br>
                                <div class="alert alert-danger move6" style=" font-size:40px; text-align:center; height:220px">
                                    <div class="move5" style=" margin-top:66px;"><b>提示:</b>该作业还没有题目</div>
                                </div><br>
