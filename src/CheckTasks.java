 ...
 */
@WebServlet(name="CheckTasks",urlPatterns="/CheckTasks")

public class CheckTasks extends HttpServlet{
    @Override
        ...
        if(check.checkLog(httpSession)) {
            ...
            try {
                ...
                for (int i = 0; i < task.length; i++) {
                    task[i] = new Task(i + 1);
                    task[i].setMy_score(user.getUser_id());
                }
            ...
            if (httpSession.getAttribute("user") != null) {
                ...
                user.setUser_last_view_page("/CheckTasks");
            }
